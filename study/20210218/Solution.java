...
public class Solution {
    public static String solution(String new_id) {
        ...
        //...!@bat#*..y.abcdefghijklm :3
        //...@bat#*..y.abcdefghijklm : 3
        //...bat#*..y.abcdefghijklm : 3(b)
        //...bat#*..y.abcdefghijklm : 4(a)
        int idx = 0;
        ...
        while(idx < sb.length()) {
            ...
            int ascii = (int) c; 
            tmp.setLength(0);           
            if(c != '-' && c != '_' && c != '.' && (ascii < 48 && ascii > 57) && (ascii < 97 && ascii > 122)) {
            ...
            else if(idx < sb.length()-1 && sb.charAt(idx)=='.'&&sb.charAt(idx+1)=='.') {
                tmp.append(sb.substring(0, idx));
                tmp.append(sb.substring(idx+1, sb.length()));
                sb.setLength(0);
                sb.append(tmp);
